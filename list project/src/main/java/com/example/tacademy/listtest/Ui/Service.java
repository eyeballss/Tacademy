...
public class Service extends RootActivity {
    ...
    private ArrayList<DaumSearchImageModel.Channel.Items> items;
    ...
    private void setListViewListener() {
        listView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> adapterView, View view, int i, long l) {
                Log.d("Service", "setOnItemClickListener.onItemClick");
                Intent intent = new Intent(Service.this, DetailActivity.class);
        ...
        listView.setOnItemSelectedListener(new AdapterView.OnItemSelectedListener() {
            ...
            public void onItemSelected(AdapterView<?> adapterView, View view, int i, long l) {
                Log.d("Service", "setOnItemSelectedListener.onItemSelected");

            }

            @Override
            public void onNothingSelected(AdapterView<?> adapterView) {
                Log.d("Service", "setOnItemSelectedListener.onNothingSelected");
